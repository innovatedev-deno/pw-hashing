...
// source-hash: a3b54ab08b82af58dd1309e03362360509539539
let wasm;
 ...
 * @returns {string}
 */
export function argon2_hash(password) {
  try {
    ...
    wasm.argon2_hash(retptr, ptr0, len0);
 ...
 * @returns {boolean}
 */
export function argon2_verify(password, hash) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    const ptr0 = passStringToWasm0(
      password,
 ...
 *   exports: { argon2_hash: typeof argon2_hash; argon2_verify: typeof argon2_verify }
 * }>}
 */
...
function getWasmInstanceExports() {
  return { argon2_hash, argon2_verify };
}
...
async function instantiateModule(opts) {
  const wasmUrl = opts.url ??
    new URL("deno_pw_hashing_bg.wasm", import.meta.url);
